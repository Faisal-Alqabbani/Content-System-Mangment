<a class="navbar-brand text-light" href="{{ url('/') }}" >
    {{ config('app.name', "Faisal's Content") }}
</a>
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
    <span class="navbar-toggler-icon"></span>
</button>

<div class="collapse navbar-collapse navbar-darks d-flex justify-content-between" id="navbarSupportedContent">
    <!-- Right Side Of Navbar -->
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/') }}"><i class="fa fa-home"></i>
                {{-- &nbsp;{{__('titles.Home')}} --}}
                {{__('site.Home')}}
            </a>
        </li>
    ...
    <ul class="navbar-nav">
        ...
        @else
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ Auth::user()->profile->avatar ?? asset('storage/avatar/avatar.png') }}" alt="Avatar" class="avatar">
                ...
                <div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="navbarDropdown">
                    ...
                    @endadmin
                    {{-- profile route  --}}
                    <a class="dropdown-item" href=""><i class="far fa-user fa-fw"></i>
                        Profile
                        {{-- {{__('titles.Profile')}} --}}
                    </a>
                    {{-- setting route  --}}
                    <a class="dropdown-item" href=""><i class="fas fa-cog fa-fw"></i>
                         Settings
                        {{-- {{__('titles.Settings')}} --}}
                    </a>
