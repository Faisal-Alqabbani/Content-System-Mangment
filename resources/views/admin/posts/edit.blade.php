          ...
          <div class="container">
            <form method="POST" action="{{route('post.update',$post->id)}}" enctype="multipart/form-data">
                ...
                <div class="col-lg-12 form-group">
                    ...
                    <img name="img"  class="form-control w-25 h-25 my-2" src="{{$post->image_path}}">
                    <input type="file" name="image"  class="form-control">
                </div>

                <div class="col-lg-12 form-group">
                    <label for="body"> المحتوى </label>
                    <textarea class="form-control col my-2" name="body" rows="3"  >{{$post->body}}</textarea>
                </div>

                <div class="col-lg-12 form-group">
                    <button type="submit" class="btn btn-outline-primary mt-3">تحديث </button>
                </div>
            </form>
          </div>
        </div>
